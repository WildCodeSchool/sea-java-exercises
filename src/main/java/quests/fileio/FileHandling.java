...
public class FileHandling {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 6. (Opt.) In this FileHandling class is a static method sortKunden which takes the List<Kunde>, sorts this list for the names and returns the sorted List<Kunde>
        // Implement this method
